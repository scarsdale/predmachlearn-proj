...
```{r, echo=F, results="asis", cache=T, message=F, warning=F}
res <- try.models(0.8)
...
produce predictions for the test set. The random forest took about three times
as long to train, and the na&iuml;ve Bayesian classifier about ten times as long.
